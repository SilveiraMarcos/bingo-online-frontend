  ...
  return (
    <div className="container mx-auto px-3 sm:px-4 py-6 sm:py-8 max-w-2xl">
      ...
      <div className="mb-4 sm:mb-6">
        {venda.status === 'pago' && (
          <div className="bg-green-50 border border-green-200 rounded-lg p-3 sm:p-4 flex items-center gap-3">
            ...
            <div>
              <p className="text-sm sm:text-base font-medium text-green-900">Pagamento Confirmado!</p>
        ...
        {(venda.status === 'expirado' || venda.status === 'cancelado') && (
          <div className="bg-red-50 border border-red-200 rounded-lg p-3 sm:p-4 flex items-center gap-3">
            ...
            <div>
              <p className="text-sm sm:text-base font-medium text-red-900">Pagamento Expirado</p>
      ...
      {venda.status === 'pendente' && venda.paymentUrl && !venda.pixQrCode && (
        <div className="bg-white rounded-lg shadow-lg p-4 sm:p-6 mb-4 sm:mb-6">
          <div className="text-center">
            ...
            <p className="text-2xl sm:text-3xl font-bold text-green-600 mb-4 sm:mb-6">
            ...
            <a
              ...
              className="inline-block w-full bg-purple-600 text-white py-2.5 sm:py-3 px-4 sm:px-6 rounded-lg hover:bg-purple-700 transition-colors font-medium text-sm sm:text-base"
            >
      ...
      {venda.status === 'pendente' && !venda.pixQrCode && !venda.paymentUrl && (
        <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-3 sm:p-4 flex items-center gap-3 mb-4 sm:mb-6">
          <AlertCircle className="w-5 h-5 sm:w-6 sm:h-6 text-yellow-600 flex-shrink-0" />
          <div>
            <p className="text-sm sm:text-base font-medium text-yellow-900">Aguardando geração dos dados de pagamento</p>
      ...
      <div className="bg-white rounded-lg shadow-md p-4 sm:p-6 mb-4 sm:mb-6">
        <h3 className="text-base sm:text-lg font-semibold text-gray-900 mb-4">Resumo da Compra</h3>
      ...
      <div className="mt-4 sm:mt-6 bg-blue-50 border border-blue-200 rounded-lg p-3 sm:p-4">
        <h4 className="text-sm sm:text-base font-semibold text-blue-900 mb-2">Informações Importantes:</h4>
